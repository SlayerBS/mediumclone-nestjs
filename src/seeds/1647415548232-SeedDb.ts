...
export class SeedDb1647415548232 implements MigrationInterface {
  name = 'SeedDb1647415548232';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`INSERT INTO tags (name) VALUES ('dragons'), ('cofee'), ('nestjs')`);
    //password is 12345
    await queryRunner.query(
      `INSERT INTO users (username, email,password) VALUES ('foo', 'foo@gmail.com', '$2b$10$YMRDh5w5GWpmZz3Lk3aoru.aMH9WOZ6vf.VaFwR7LIVJfBNMofj1e' )`,
    );
